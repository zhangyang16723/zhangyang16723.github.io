...
![](./zy.jpg) **Yang Zhang**，PhD in computer science and technology, Wuhan National Laboratory for Optoelectronics (WNLO), **Huazhong University of Science and Technology(HUST)**, advised by **Prof. Dan Feng**(Dean of Computer Science College, Vice Principal of HUST). I'm currently a senior research and development expert in cloud computing and AI at Sangfor Technologies Inc. My research interests include computer architecture, cloud computing, distributed storage systems, RDMA, non-volatile memory, intelligent storage technologies, LLM technologies and AI Infra. At sangfor, I previously focused on distributed storage systems and intelligent storage technologies. And now I'm an experienced expert in LLM technologies, responsible for the **Sales Agent project**, a universal chatbot with sales logics to assist real salesmen.
...
## Honor
- 2026/01. Annual Innovation Special Grand Prize@Sangfor Technologies Inc. (bonus:1,000,000 rmb)
